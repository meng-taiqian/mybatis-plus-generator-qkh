...
public class ConstVal {
    ...
    public static final String TEMPLATE_ISERVICE = "/templates/iservice.java.vm";
    public static final String TEMPLATE_ISERVICEIMPL = "/templates/iserviceImpl.java.vm";
